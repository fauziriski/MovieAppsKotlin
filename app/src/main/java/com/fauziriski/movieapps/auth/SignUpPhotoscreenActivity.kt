...
class SignUpPhotoscreenActivity : AppCompatActivity(), PermissionListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_home.setOnClickListener {
            var moveHome = Intent(this@SignUpPhotoscreenActivity, HomeActivity::class.java)
    ...
    override fun onPermissionDenied(response: PermissionDeniedResponse?) {
        Toast.makeText(this, "Anda Tidak Dapat Menambahkan Photo Profile"
                , Toast.LENGTH_LONG).show()
    }

    override fun onBackPressed() {
        Toast.makeText(this, "Kembali, Anda Belum Memilih Foto", Toast.LENGTH_LONG).show()
    }
